...
import { getPlayerWithMatches } from '@/services/player';
...
export async function GET(
  ...
  return withApi(req, async () => {
    ...
    logger.info('player request', { region, gameName, tagLine });
    const data = await getPlayerWithMatches(region, gameName, tagLine);
